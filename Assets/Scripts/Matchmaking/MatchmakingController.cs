...
namespace UnityEngine.Ucg.Matchmaking
{
    class MatchmakingController
    {
        ...
        CreateTicketResponse create_response;
        ...
        /// </summary>
        internal void StartRequestMatch(Ticket ticket, RequestMatchSuccess successCallback, RequestMatchError errorCallback)
        {
            ...
            create_response = openMatchClient.CreateTicket(ticket);
            Debug.Log("Ticket created: " + create_response.Ticket.Id);
        }
        ...
        /// </summary>
        internal async void StartGetAssignment(Ticket ticket, GetAssignmentSuccess successCallback, GetAssignmentError errorCallback)
        {
            ...
            await openMatchClient.GetUpdates(ticket);
        }
